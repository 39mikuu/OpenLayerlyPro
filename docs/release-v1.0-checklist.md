...
> 本文档是当前发布门槛的验收矩阵，原对应 issue #88（已关闭）。当前按 issue #104 对审计修复后的冻结 exact-main 候选（前置含 #119）重跑本矩阵；#93 的历史证据不得视为新候选的证明。旧的 `release-v0.2-checklist.md` 已被本清单取代，仅保留为历史说明。
