...
当前发布状态：v1.0 pre-release。S1a/S1b/S2/S3/S4/S5 与订阅已实现；剩余主线是 S6 #86 → S7 #87 → 最终验收 #88。▶
...
已完成：MVP → 安全基础 → 配置中心 → 网络边缘 → Integration 基座 → Theme v1 基座 → UI i18n → Content i18n/AI → v1 Core hardening → 自动支付/订阅/文件能力 → S1a–S5。

当前：S6 #86 → S7 #87 → v1.0 最终验收与发布 #88。
