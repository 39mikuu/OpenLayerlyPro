...
当前发布状态：v1.1.0 release-ready。M1-M4 已合并（`97547b6`），package version 1.1.0；M5 全部验收证据已于 2026-07-16 收集完成（见 docs/releases/v1.1.0-release-notes.md），待发布 PR 合并后打 tag。▶
