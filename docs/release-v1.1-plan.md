...
> 状态：**WP1 实现与验收完成并已合并（PR #123，exact-head CI run #554 通过）；WP2 新内容邮件通知已按 M3 交付代码与文档同步，真实 SMTP / 部署 dogfood 仍保留为发布门槛；WP5–WP6 按本文档里程碑继续推进**。本文档定义 v1.1 的目标、产品优先级、实施顺序与发布门槛。
