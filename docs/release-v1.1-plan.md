...
> 状态：**M1-M4 已合并；v1.1.0 release prep in progress at `97547b6`；M5 验收与发布进行中**。真实 SMTP、部署 dogfood、`v1.0.0` 原地升级和带通知 key 的 backup/restore drill 仍保留为发布门槛。本文档定义 v1.1 的目标、产品优先级、实施顺序与发布门槛。
