...
S7 #87 → v1.0 最终验收 #88 是历史发布主线，不是当前唯一发布主线。当前版本的完成度与正式发布状态必须以当前代码、路线图和对应 release 文档分别判断；“相关工作已进入 `main`”本身不等同于已正式发布。已完成 handoff 不应仅因正文保留历史时态而被当作未完成任务，也不应直接复制为当前运维步骤。
