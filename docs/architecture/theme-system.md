...
> Theme v1 基座已落地：主题数据契约、全部公开页面契约化、内置主题标准化，以及明暗切换、字体、颜色预设与自由取色。第二主题（Blog）与后台活动主题选择器已在 v1.1 WP1 落地（见「第三步」）。安装式主题包与第三方主题生命周期仍推迟到 Plugin 阶段（见文末 Deferred follow-up）。
