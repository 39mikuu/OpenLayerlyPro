...
export const ja: Messages = {
  ...
  supporters: {
    eyebrow: "支援者ウォール",
    title: "支援者ウォール",
    subtitle: "クリエイターの継続的な活動を支えるメンバーへの感謝を掲載します。",
    empty: "公開表示されている支援者はまだいません。",
    noDedication: "この支援者はまだメッセージを残していません。",
    sidebarTitle: "このウォールについて",
    sidebarDescription: "承認済みで、現在も条件を満たすメンバーのメッセージのみ表示します。",
    seoTitle: "支援者ウォール",
    seoDescription: "このクリエイターを支えるメンバーへの感謝を確認できます。",
  },
  me: {
    title: "マイアカウント",
    ...
    roleAdmin: "管理者",
    roleFan: "ファン",
    displayNameTitle: "公開表示名",
    displayNameDescription:
      "支援者ウォールで使う名前を設定します。メールアドレスは表示されません。",
    displayNameLabel: "表示名",
    displayNamePlaceholder: "例：Studio Fan",
    displayNameHint:
      "1〜50文字。クリアすると、承認済みのウォール掲載も公開ページから非表示になります。",
    displayNameSave: "表示名を保存",
    displayNameSaving: "保存中…",
    displayNameClear: "表示名をクリア",
    displayNameFailed: "表示名を更新できませんでした",
    supporterWallTitle: "支援者ウォール",
    supporterWallDescription:
      "表示名、メンバーシッププラン、メッセージを公開するか選べます。編集後は再度レビューが必要です。",
    supporterWallEnabledHint: "公開支援者ウォールは現在有効です。",
    supporterWallDisabledHint: "公開支援者ウォールは現在無効です。メッセージは事前に編集できます。",
    supporterWallDisplayNameRequired:
      "先に表示名を設定してください。メールアドレスは公開名の代わりに使われません。",
    supporterWallDedicationLabel: "メッセージ（任意）",
    supporterWallDedicationPlaceholder: "クリエイターへの短いメッセージ",
    supporterWallDedicationCount: "{count}/200",
    supporterWallSave: "ウォール掲載を送信",
    supporterWallSaving: "送信中…",
    supporterWallOptOut: "ウォールから退出",
    supporterWallSaveFailed: "支援者ウォール設定を保存できませんでした",
    supporterWallOptOutFailed: "支援者ウォールから退出できませんでした",
    supporterWallNotJoined: "まだ送信されていません",
    supporterWallStatuspending: "レビュー待ち",
    supporterWallStatusapproved: "公開表示中",
    supporterWallStatushidden: "非表示",
  ...
  login: {
    ...
    challengeMissing: "このブラウザにログイン確認情報がありません。コードを再送してください。",
    resend: "再送信",
    sendCode: "認証コードを送信",
    ...
    orEmail: "またはメール",
    turnstileLoadFailed:
      "人間確認を読み込めませんでした。ネットワークを確認して再試行してください。",
    turnstileReload: "人間確認を再読み込み",
    oauthError: {
  ...
  admin: {
    ...
    shell: {
      navigation: "管理画面ナビゲーション",
      openMenu: "管理メニューを開く",
      closeMenu: "管理メニューを閉じる",
      menuTitle: "管理メニュー",
      menuDescription: "移動先の管理ページを選択します。",
    ...
    files: {
      ...
      storage: "ストレージ",
      uploadedAt: "アップロード日時",
      quarantinedTitle: "隔離ファイル",
      quarantinedDescription:
        "メタデータのみ表示します。隔離されたデータはダウンロード、プレビュー、エクスポート、制限の解除ができません。",
    ...
    notifications: {
      ...
      statuscompleted: "完了",
      statusdead: "停止",
      source_manual_publish: "手動公開",
      source_scheduled_publish: "予約公開",
      deliveryqueued: "待機中",
      deliverysending: "送信中",
      deliveryaccepted: "受付済み",
      deliverysuppressed: "抑制済み",
      deliveryskipped: "スキップ済み",
      deliverydeferred: "延期済み",
      deliveryfailed: "失敗",
      deliverydead: "停止",
      attemptstarted: "開始済み",
      attemptaccepted: "受付済み",
      attemptpermanent_failure: "恒久的な失敗",
      attempttransient_failure: "一時的な失敗",
      attemptsuppressed_skip: "抑制してスキップ",
      attemptbudget_defer: "上限により延期",
      attemptpacing_defer: "送信間隔により延期",
      attemptpreference_disabled_skip: "通知設定が無効",
      attemptpost_not_published_skip: "投稿が未公開",
      attemptaccess_lost_skip: "アクセス権を喪失",
      attemptuser_missing_skip: "ユーザーなし",
      attemptstale_skip: "期限切れでスキップ",
      attemptneeds_operator_defer: "管理者確認待ち",
      attemptlease_expired: "リース期限切れ",
      suppressions: "抑制対象",
      noCounts: "記録なし",
      countLabel: "{label}：{count}",
      expansionCompleted: "展開完了日時",
      diagnostics: "技術詳細",
      cursorUserId: "展開カーソルのユーザー ID",
      viewError: "エラー詳細を表示",
      empty: "通知キャンペーンはまだありません。",
    },
    supporterWall: {
      title: "支援者ウォール",
      description: "ファンの公開メッセージをレビューし、ウォールの公開状態を管理します。",
      settingsTitle: "公開設定",
      settingsDescription:
        "無効にすると /supporters は 404 になり、テーマのナビゲーションも非表示になります。",
      enabled: "公開支援者ウォールを有効にする",
      minLevel: "最低メンバーシップレベル",
      minLevelPlaceholder: "空欄なら全レベル",
      minLevelHint:
        "0以上の整数を指定すると、現在の最高レベルが条件を満たすメンバーのみ表示します。",
      entriesTitle: "レビュー待ちと表示中の掲載",
      displayName: "表示名",
      tier: "現在の最高プラン",
      dedication: "メッセージ",
      updatedAt: "更新日時",
      noDedication: "メッセージなし",
      empty: "支援者ウォールの掲載はまだありません。",
      ...
      approveDescription:
        "承認後、ファンが引き続き条件を満たしていれば公開ウォールに表示されます。",
      confirmApprove: "承認する",
      hide: "非表示",
      hiding: "非表示にしています…",
      hideTitle: "このメッセージを非表示にしますか？",
      hideDescription: "非表示にしたメッセージは公開支援者ウォールに表示されません。",
      confirmHide: "非表示にする",
      moderationFailed: "支援者ウォールのレビュー操作に失敗しました",
    },
    taxonomy: {
      title: "カテゴリーとタグ",
      categories: "カテゴリー",
    ...
    reviews: {
      ...
      approveDialogTitle: "支払い申請を承認",
      rejectDialogTitle: "支払い申請を却下",
      reviewDialogDescription:
        "続行する前に、ユーザー、プラン、金額、証明、メモを確認してください。",
      approveImpact:
        "承認すると、このメンバーシッププランがすぐにユーザーへ付与されます。入金と証明を確認してください。",
      confirmApproveAction: "承認してメンバーシップを付与",
      confirmRejectAction: "申請を却下",
      approving: "承認中…",
      rejecting: "却下中…",
      rejectReasonLabel: "却下理由",
      rejectDetailsLabel: "補足説明（任意）",
      rejectDetailsPlaceholder: "補足説明はファンに表示され、正しい証明の再送信に役立ちます。",
      rejectReason: {
        proof_unclear: "支払い証明が不鮮明または情報不足です",
        wrong_amount: "支払い金額が一致しません",
        wrong_account: "支払いアカウントまたは方法が一致しません",
        duplicate: "重複申請または処理済みです",
        other: "その他の理由",
      },
    ...
    system: {
      ...
      taskQueue: "タスクキューとリースのスナップショット",
      queueCapturedAt: "取得時刻",
      queueDue: "実行期限到来・取得可能",
      queueScheduled: "予定時刻待ち",
      queueActiveLeases: "有効なリース",
      queueStaleLeases: "期限切れ・再取得可能なリース",
      queueExhausted: "最終リース期限切れ・収束待ち",
      queueStranded: "試行上限到達・未処理",
      queueDead: "停止タスク",
      queueFenceAnomalies: "Fence メタデータ異常",
      queueOldestDue: "最も古い実行期限",
      queueUnavailable: "タスクキューのスナップショットを取得できません。",
      queueTransactional: "トランザクション通知",
      queueAuthDelivery: "ログインリンク v2 配信",
      queueAuthIntake: "ログインリンク受付",
      queueNotification: "コンテンツ通知",
      queueMaintenance: "メンテナンス",
      queueDefault: "デフォルト",
    },
    integrationTest: {
      label: "接続テスト",
    ...
    upload: {
      ...
      proofHint:
        "支払いスクリーンショットと QR 画像のファイルごとの上限です。環境変数の {size} MB は超えられない上限です。",
      proofHintClamped:
        "環境変数の {size} MB は超えられない上限です。これを超える保存値は制限され、現在の有効値は {effective} MB です。",
      applyHint:
  ...
  errors: {
    ...
    displayNameRequired: "先に表示名を設定してください",
    supporterWallDedicationTooLong: "メッセージは200文字以内にしてください",
    supporterWallInvalidMinLevel: "最低メンバーシップレベルには0以上の整数を指定してください",
    supporterWallEntryNotFound: "支援者ウォールの掲載が見つかりません",
    supporterWallEntryStale: "この掲載は更新されています。再読み込みして再試行してください。",
