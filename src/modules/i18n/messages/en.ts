...
export const en: Messages = {
  ...
  login: {
    ...
    challengeMissing: "This browser is missing the login verification. Send a new code and retry.",
    resend: "Resend",
    sendCode: "Send code",
    ...
    turnstileLoadFailed: "Human verification failed to load. Check your connection and try again.",
    turnstileReload: "Reload human verification",
    oauthError: {
  ...
  admin: {
    ...
    files: {
      ...
      quarantinedTitle: "Quarantined files",
    ...
    notifications: {
      ...
      statusdead: "Dead",
      source_manual_publish: "Manual publish",
      source_scheduled_publish: "Scheduled publish",
      ...
      attemptpermanent_failure: "Permanent failure",
      attempttransient_failure: "Transient failure",
      attemptsuppressed_skip: "Suppressed and skipped",
      attemptbudget_defer: "Deferred by quota",
      attemptpacing_defer: "Deferred by pacing",
      attemptpreference_disabled_skip: "Notification preference disabled",
      attemptpost_not_published_skip: "Post not published",
      attemptaccess_lost_skip: "Access lost",
      attemptuser_missing_skip: "User missing",
      attemptstale_skip: "Stale and skipped",
      attemptneeds_operator_defer: "Awaiting operator review",
      attemptlease_expired: "Lease expired",
      suppressions: "Suppressions",
      noCounts: "No records",
      countLabel: "{label}: {count}",
      expansionCompleted: "Expansion completed",
      diagnostics: "Technical details",
      cursorUserId: "Expansion cursor user ID",
    ...
    tiers: {
      ...
      slug: "Slug",
      price: "Price label",
      pricePlaceholder: "For example: $5 / month",
    ...
    site: {
      ...
      colorPresetNames: {
        ...
        teal: "Teal",
        amber: "Amber",
        gofunSeiji: "Gofun × Ink × Seiji",
        layerSeal: "Layer Seal",
      },
      custom: "Custom",
    ...
    system: {
      ...
      taskQueue: "Task queue and lease snapshot",
      queueCapturedAt: "Captured at",
      queueDue: "Due and claimable",
      queueScheduled: "Waiting for schedule",
      queueActiveLeases: "Active leases",
      queueStaleLeases: "Stale reclaimable leases",
      queueExhausted: "Expired final leases awaiting sweep",
      queueStranded: "Exhausted but unprocessed",
      queueDead: "Dead tasks",
      queueFenceAnomalies: "Fence metadata anomalies",
      queueOldestDue: "Oldest due",
      queueUnavailable: "Task queue snapshot is unavailable.",
      queueTransactional: "Transactional notifications",
      queueAuthDelivery: "Login link v2 delivery",
      queueAuthIntake: "Login link intake",
      queueNotification: "Content notifications",
